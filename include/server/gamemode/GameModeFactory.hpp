...
public:
    GameModeFactory(const char* fName) : al::Factory<createMode>(fName, modeTable) {
        this->mFactoryName = fName;
        this->mFactoryEntries = modeTable;
        this->mNumFactoryEntries = sizeof(modeTable) / sizeof(modeTable[0]);
    };
